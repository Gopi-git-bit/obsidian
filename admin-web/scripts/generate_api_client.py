...
METHOD_NAMES = {
    ...
    ("get", "/api/v1/orders/{order_id}/events"): "getOrderEvents",
    ("post", "/api/v1/orders/{order_id}/transition"): "transitionOrder",
    ("get", "/api/v1/orders/{order_id}/flow-summary"): "getOrderFlowSummary",
    ("post", "/api/v1/orders/{order_id}/quote"): "createQuote",
    ("get", "/api/v1/orders/{order_id}/match"): "findMatches",
    ("post", "/api/v1/matches/{match_id}/accept"): "acceptMatch",
    ("post", "/api/v1/orders/{order_id}/payments/advance"): "recordAdvancePayment",
    ("post", "/api/v1/trips/{trip_id}/loading-photo"): "uploadLoadingPhoto",
    ("post", "/api/v1/trips/{trip_id}/milestones"): "recordTripMilestone",
    ("post", "/api/v1/trips/{trip_id}/pod"): "uploadPod",
