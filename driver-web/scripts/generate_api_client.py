...
METHOD_NAMES = {
    ...
    ("get", "/api/v1/driver/trips"): "listDriverTrips",
    ("get", "/api/v1/driver/trips/{trip_id}"): "getDriverTrip",
    ("post", "/api/v1/driver/trips/{trip_id}/acknowledge"): "acknowledgeTrip",
    ...
    ("post", "/api/v1/trips/{trip_id}/assign-driver"): "assignTripDriver",
