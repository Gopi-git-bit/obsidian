...
METHOD_NAMES = {
    ...
    ("get", "/api/v1/supervisor/cases"): "listCases",
    ("get", "/api/v1/supervisor/cases/{case_id}"): "getCase",
    ("post", "/api/v1/supervisor/cases/{case_id}/hold"): "holdCase",
    ("post", "/api/v1/supervisor/cases/{case_id}/approve"): "approveCase",
    ("post", "/api/v1/supervisor/cases/{case_id}/reject"): "rejectCase",
    ("post", "/api/v1/supervisor/orders/{order_id}/fraud-hold"): "placeFraudHold",
    ("post", "/api/v1/supervisor/settlements/{settlement_id}/hold"): "placeSettlementHold",
    ("post", "/api/v1/supervisor/settlements/{settlement_id}/release-hold"): "releaseSettlementHold",
    ("post", "/api/v1/trips/{trip_id}/pod/verify"): "verifyPod",
    ("post", "/api/v1/trips/{trip_id}/otp/verify"): "verifyOtp",
}
