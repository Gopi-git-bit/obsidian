...
METHOD_NAMES = {
    ...
    ("get", "/api/v1/vehicles/{vehicle_id}"): "getVehicle",
    ("patch", "/api/v1/vehicles/{vehicle_id}"): "updateVehicle",
    ("get", "/api/v1/matches"): "listMatches",
    ("post", "/api/v1/matches/{match_id}/accept"): "acceptMatch",
    ("post", "/api/v1/matches/{match_id}/reject"): "rejectMatch",
    ("get", "/api/v1/transport-company/trips"): "listTrips",
    ("get", "/api/v1/transport-company/trips/{trip_id}"): "getTrip",
